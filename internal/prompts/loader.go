...
// It checks Rho user config first for user overrides, then falls back to embedded templates.
...
// It checks Rho user config prompts first, then falls back to embedded.
