// Package prompts manages workspace context for rho sessions.
// This file implements auto-accumulation of learnings into Rho user state.
package prompts
...
// Flush writes all buffered learnings to Rho user state.
