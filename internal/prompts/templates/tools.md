...
- URLs are a supported Rho capability. When the user asks you to open, check, merlin, read, or verify a URL, use a web tool instead of claiming that you cannot access the internet.
