...
const (
	EnvSpawnV2     = "RHO_Y0_SPAWN_V2"
	EnvFolderTrust = "RHO_Y0_FOLDER_TRUST"
	EnvMarketplace = "RHO_Y0_MARKETPLACE"
)
...
// Default true after PACK-03 (secure by default). Set RHO_Y0_FOLDER_TRUST=0 to disable.
...
// Default true after PACK-05. Set RHO_Y0_MARKETPLACE=0 to disable remote installs.
