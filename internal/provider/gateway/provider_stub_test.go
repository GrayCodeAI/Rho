...
func (s *stubProvider) StatePaths() eyrieengine.StatePaths {
	return eyrieengine.StatePaths{}
}
...
func (s *stubProvider) ActiveSelection(context.Context) eyrieengine.Route {
	return eyrieengine.Route{}
}
