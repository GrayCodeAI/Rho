...
var updateURL = "https://api.github.com/repos/GrayCodeAI/rho/releases/latest"
...
func Summary(currentVersion string) string {
	...
	if release == nil {
		return fmt.Sprintf("rho is up to date (%s)", currentVersion)
	}
