...
// Useful for finding relationships between rho, eyrie, and other packages.
...
// If a symbol in rho calls a symbol in eyrie, this traces that cross-repo dependency.
...
// For example, rho calling eyrie functions.
