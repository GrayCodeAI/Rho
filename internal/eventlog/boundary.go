...
// Rho fields are the primary model (turn/step/tool/category/question); DSH
...
// Rho fields are the primary model (turn/step/tool/category/allowed/message);
...
// DSH parity: PresetName and Source fields added alongside Rho's Category/Covered.
