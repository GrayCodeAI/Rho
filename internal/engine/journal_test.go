...
func TestJournaledAppendKeepsTranscriptAndProjectionInSync(t *testing.T) {
	...
	ps.AppendUserJournaled(types.FluxMessage{Role: "user", Content: "pre-journal"})
...
func TestJournaledAppendPreservesToolFactoryRoundTrip(t *testing.T) {
	...
	ps.AppendUserJournaled(types.FluxMessage{
		Role:    "user",
		Content: "tool result",
...
func TestReplayJournalRebuildsLogFromWire(t *testing.T) {
	...
	restored.AppendUserJournaled(types.FluxMessage{Role: "user", Content: "next"})
...
func TestJournaledAppendContentPartsRoundTrip(t *testing.T) {
	...
	in := types.FluxMessage{Role: "user", Content: "see image", ContentParts: []types.ContentPart{{Type: "image_url", ImageURL: img}}}
