...
func isRecentToolHeavy(messages []types.FluxMessage) bool {
	const lookback = 3
	toolTurns := 0
	assistantSeen := 0
...
func isTextQuestion(messages []types.FluxMessage) bool {
...
func classifyPromptForBudget(messages []types.FluxMessage) string {
