...
import (
	...
	"github.com/GrayCodeAI/rho/internal/systemcontext"
)

// Section defines a dynamic, incrementally-rendered system-prompt section. It
// is the rho-host integration of the systemcontext package: each section is a
...
// a session, wired to the same loaders rho already uses for each. It is a
