...
func NewCapabilityRegistry() *CapabilityRegistry {
	...
	for i := range builtinCapabilities {
		...
		// Deep-copy the slice fields so a registry cannot mutate the shared
		// catalog through a capability it hands out.
		cap.Tools = append([]string(nil), cap.Tools...)
		cap.Examples = append([]string(nil), cap.Examples...)
...
// builtinCapabilities is the static capability catalog consulted by
...
func (r *CapabilityRegistry) FormatHelp() string {
	...
	sb.WriteString("rho Capabilities:\n")
