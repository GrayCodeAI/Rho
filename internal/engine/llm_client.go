...
type LLMClient interface {
	Chat(ctx context.Context, msgs []types.FluxMessage, opts types.ChatOptions) (*types.FluxResponse, error)
}
...
func (r *Reflector) Reflect(ctx context.Context, goal string, msgs []types.FluxMessage, errorContext string) (*ReflectionEntry, error) {
	if r.llm == nil {
	...
	allMsgs := []types.FluxMessage{{Role: "user", Content: prompt}}
...
func buildReflectionPrompt(goal string, msgs []types.FluxMessage, errorContext string) string {
