...
func clearOldToolResults(msgs []types.FluxMessage, estimatedTokens, threshold int) ([]types.FluxMessage, int) {
...
func toolResultBytes(m types.FluxMessage) int {
	total := 0
...
func clearMessageToolResults(m *types.FluxMessage) int {
	freedBytes := 0
...
func cloneToolResults(msgs []types.FluxMessage) []types.FluxMessage {
