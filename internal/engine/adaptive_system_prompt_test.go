...
func TestAddSection(t *testing.T) {
	...
	b.AddSection(PromptSection{Name: "identity", Content: "You are rho.", Priority: 1})
	...
	b.AddSection(PromptSection{Name: "identity", Content: "You are rho v2.", Priority: 1})
	if len(b.Sections) != 2 {
		t.Fatalf("expected 2 sections after replace, got %d", len(b.Sections))
	}
	if b.Sections[0].Content != "You are rho v2." {
...
func TestFormatPrompt(t *testing.T) {
	sections := []PromptSection{
		{Name: "identity", Content: "You are rho."},
	...
	if !strings.Contains(result, "You are rho.") {
