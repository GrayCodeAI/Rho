...
// staying hidden from FluxTools until promoted (ToolSearch select, mode, etc.).
...
// FluxTools until PromoteModelTool.
...
// IsModelVisible reports whether name is included in FluxTools.
