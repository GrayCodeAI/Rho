...
// TestBashInjectionPatternCoverage locks in rho's safety layer against
...
func TestExtractTargetsSchemaAware(t *testing.T) {
	...
	// FIXME: extractTargets enhancement tracked in fix/rho-safety-and-tool-hardening
	t.Skip("extractTargets enhancement tracked in fix/rho-safety-and-tool-hardening")
}
