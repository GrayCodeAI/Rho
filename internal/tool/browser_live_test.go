...
// TODO: https://github.com/GrayCodeAI/rho/issues/273 track live-browser CI coverage.
func TestBrowserLive(t *testing.T) {
	if os.Getenv("RHO_LIVE_BROWSER") == "" {
		// TODO: https://github.com/GrayCodeAI/rho/issues/273 live-browser CI coverage.
		t.Skip("requires RHO_LIVE_BROWSER=1 and a Chrome/Chromium binary")
	}
