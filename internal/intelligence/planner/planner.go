...
// analysis, and can persist/load plans as JSON files under Rho user state.
package planner
...
// This is a template -- the actual LLM call happens in rho's engine.
...
// Save writes the plan to Rho project state.
