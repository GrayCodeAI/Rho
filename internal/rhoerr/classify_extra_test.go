...
func TestClassifyError_AgnesPreDeductionQuota(t *testing.T) {
	err := errors.New("flux: agnes chat failed (HTTP 403) [request_id=202607300111184425982109LnnftLG]: " +
...
// The flux layer tags quota holds as "billing/quota problem"; a bare hint
