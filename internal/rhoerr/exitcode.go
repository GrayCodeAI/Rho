...
// Exit-code taxonomy.
//
// rho historically collapsed every failure to exit code 1, which gives an
// agent or shell script driving `rho --print` no way to branch on *why* the
...
// (3).
//
// The numbers are part of rho's public CLI contract — append new codes, do
