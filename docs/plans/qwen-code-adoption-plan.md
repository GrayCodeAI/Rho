...
Status: Implemented selectively in the current Rho feature branch.
...
4. Preserved Rho's existing cancellation transcript cleanup and compaction.
...
- Map Markdown subagent frontmatter to Rho's typed SpawnRequest.
...
- Full Rho build, vet, and test suite.
