...
- `GenerateShareLink` returns local deeplink `rho://share/<hash[:16]>` (`internal/session/export.go:801-819`); deterministic, no hosted URL.
...
- P1: TUI session picker surfaces the `rho://share/<id>` deeplink + export file path for copy-paste.
