...
**Full matrices:** [FULL-GROK-ECO-TO-RHO-ECO-PORT-PLAN.md](./FULL-GROK-ECO-TO-RHO-ECO-PORT-PLAN.md),
...
- [x] Folder trust gates project hooks / plugins (`.rho/plugins`, `.rho/hooks`; MCP/LSP follow same AllowLoadPath)
...
- [x] User-guide docs `01`–`24` under `rho/docs/user-guide/` (completed July 2026)
...
| Env | Default | Purpose |
|-----|---------|---------|
| `RHO_Y0_SPAWN_V2` | `1` once PACK-02 ships; `0` during dual path | Typed SpawnRequest path |
| `RHO_Y0_FOLDER_TRUST` | `1` recommended after PACK-03 | Gate project automation |
| `RHO_Y0_MARKETPLACE` | `0` until PACK-05 + trust | Marketplace install path |
