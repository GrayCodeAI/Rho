...
- swift should capture metadata and references, not dump unnecessary raw secrets
- swift should be structured first, human-readable second
...
In the local CLI world, swift primarily supports:

- debugging
- reproduction
- replay
- audit of what Rho changed and why
