...
- [x] Rho production code imports Eyrie only through `eyrie/engine`
...
- [x] Rho owns runtime DTOs in `internal/types` and translates them to `eyrie/engine` in `internal/engine`
