# Rho Permission Model — Improvements (2026-08-07)

This document describes the improvements made to rho's permission, isolation,
...
**Solution:** `seatbelt.go` `init()` removes orphaned `rho-seatbelt-*.sb` files from
