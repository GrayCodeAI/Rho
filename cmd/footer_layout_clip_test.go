...
func TestLayoutFooterRow_TokensSurviveFinishFooterLine(t *testing.T) {
	...
	left := lipgloss.NewStyle().Foreground(statusCWDColor).Inline(true).Render("~/OSS2026/RealWork/graycode-eco/rho")
...
func TestLayoutFooterRow_ClipDoesNotDropStyledTokens(t *testing.T) {
	...
	left := lipgloss.NewStyle().Foreground(statusCWDColor).Inline(true).Render("~/Desktop/OSS2026/RealWork/graycode-eco/rho")
