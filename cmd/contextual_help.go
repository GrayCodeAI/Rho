...
func (ch *ContextualHelp) registerAllEntries() {
	for _, entry := range builtinHelpEntries {
		ch.Entries[entry.Topic] = entry
	}
}

// builtinHelpEntries is the static contextual-help catalog.
var builtinHelpEntries = []*HelpEntry{
	// ─── Slash Commands ───────────────────────────────────────────
	{
		Topic:    "/commit",
	...
	},
	{
		...
		Detail:   "Reverts the last rho action (commit, file edit, etc.) using safe snapshot-based rollback.",
	...
	},
	{
		...
		Detail:   "Opens the interactive configuration panel for rho settings, model selection, and preferences.",
	...
	{
		Topic:    "/session",
		Summary:  "Manage rho sessions",
		Detail:   "Start, stop, resume, or list rho working sessions with full context preservation.",
	...
	// ─── Common Tasks ────────────────────────────────────────────
	{
		...
		Summary:  "Fixing failing tests with rho",
	...
	{
		Topic:    "how to commit",
		Summary:  "Making commits with rho",
	...
	{
		Topic:    "how to debug",
		Summary:  "Debugging with rho AI assistance",
	...
	},
	{
		...
		Detail:   "Use /chat to discuss refactoring strategies, then rho can apply changes. Use /snapshot before large refactors for safety.",
	...
	},
	{
		...
		Summary:  "Starting a new rho session",
		Detail:   "Run rho in your project directory to start a session. Your context is preserved across the session. Use /session to manage sessions.",
		Examples: []string{"rho                 — start rho in current dir", "/session new         — start fresh session", "/session resume      — resume last session"},
	...
	// ─── Error Explanations ──────────────────────────────────────
	{
		...
		Examples: []string{"/config              — paste API key in the config panel", "rho credentials status — verify stored keys"},
	...
	},
	{
		...
		Detail:   "You have exceeded the API rate limit. Rho will automatically retry with exponential backoff. Consider upgrading your plan for higher limits.",
	...
	},
	{
		...
		Detail:   "A merge conflict was encountered. Rho can assist with conflict resolution using AI to understand both sides.",
	...
	},
	{
		...
		Detail:   "Rho requires a git repository. Initialize one with git init or navigate to an existing repo.",
	...
	},
	{
		...
		Examples: []string{"/config              — paste API key in the config panel", "/config key remove   — remove a stored key", "rho credentials status — list configured providers"},
	...
	},
	{
		...
		Detail:   "Configure which editor rho uses when opening files for editing.",
	...
	},
	{
		...
		Detail:   "Choose the color theme for rho terminal output. Supports light and dark terminal backgrounds.",
	...
	},
	{
		...
		Detail:   "Configure which shell rho uses when running commands.",
	...
	},
	{
		...
		Detail:   "Runs shell commands in the workspace. Destructive patterns are blocked and every call is subject to the active autonomy tier.",
		Examples: []string{"/test                — runs the project test command", "/fix                 — validates fixes"},
	...
	},
	{
		...
		Examples: []string{"rho daemon start    — start the daemon", "rho daemon status   — check daemon status", "rho daemon stop     — stop the daemon"},
