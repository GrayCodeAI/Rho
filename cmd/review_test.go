...
func TestReviewStore_CreateAndGet(t *testing.T) {
	...
	os.MkdirAll(filepath.Join(dir, ".rho"), 0o755)
...
func TestHookScript_ContainsRhoReview(t *testing.T) {
	if !strings.Contains(hookScript, "rho review") {
		t.Error("hook script should contain 'rho review'")
	}
